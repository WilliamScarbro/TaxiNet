    ...
    for i in range(n):
        ...
        for cte_file in cte_sample_files:
            for he_file in he_sample_files:
                ...
                print(f"{cte_corr},{he_corr},{ce_crash_prob},{cm_crash_prob}")
...
if __name__ == "__main__":
    csv_file = "lib/corr_exp2.csv"
    model = linear_regression(csv_file)

# if __name__=="__main__":
#     error_corr_experiment(20)
